...
export default function NaturePage({
    ...
    const { id } = useParams();
    const initialIndex = natureContents.findIndex((item) => item.id === parseInt(id, 10));
    ...
    const handleNext = () => { if (page < natureContents.length - 1) setPage(page + 1); };
